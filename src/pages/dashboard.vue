      ...
      <div class="row q-col-gutter-sm q-ma-xs q-mr-sm">
          ...
          <q-card flat bordered class="">
            <q-card-section class="row">
              <div class="text-h6 col-12">Sales vs Goals
                <q-btn flat dense icon="fas fa-download" class="float-right" :color="!$q.dark.isActive? 'grey-8':'white'"
                       @click="SaveImage('bar')">
            ...
            <q-card-section>
              <IEcharts ref="bar" :option="barOptions" :resizable="true" style="height:220px"/>
            </q-card-section>
          </q-card>
        </div>
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
          ...
          <q-card flat bordered class="">
            ...
            <q-card-section>
              <IEcharts ref="gauge" :option="gaugeOptions" :resizable="true" style="height:220px"/>
            </q-card-section>
          </q-card>
        </div>
      </div>
