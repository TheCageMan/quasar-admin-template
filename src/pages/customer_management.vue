            ...
            <q-list>
              <q-item>
                <q-item-section>
                  ...
                  <q-input v-model="customer.name" dense outlined label="Customer Name"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label class="q-pb-xs">City</q-item-label>
                  <q-input v-model="customer.city" dense outlined label="City"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label class="q-pb-xs">State</q-item-label>
                  <q-input v-model="customer.state" dense outlined label="State"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
