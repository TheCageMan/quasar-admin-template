    ...
    <q-card>
      ...
      >
        <template v-slot:top-right="props">
          <q-btn outline color="primary" label="Add New" class="q-mr-xs" @click="new_customer=true"/>
      ...
      <q-card style="width: 600px; max-width: 60vw;">
        <q-card-section>
          <div class="text-h6">
            ...
            <q-btn v-close-popup round flat dense icon="close" class="float-right" color="grey-8"></q-btn>
          </div>
        </q-card-section>
            ...
            <q-list>
              <q-item>
                <q-item-section>
                  ...
                  <q-input v-model="customer.name" dense outlined label="Change Name"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label class="q-pb-xs">Change Type</q-item-label>
                  <q-input v-model="customer.change_type" dense outlined label="Change Type"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label class="q-pb-xs">New Address Information</q-item-label>
                  <q-input v-model="customer.new_address" dense outlined label="New Address Information"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label class="q-pb-xs">Status</q-item-label>
                  <q-input v-model="customer.status" dense outlined label="Status"/>
                </q-item-section>
              </q-item>
            </q-list>
          </q-form>
