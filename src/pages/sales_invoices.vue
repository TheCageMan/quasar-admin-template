            ...
            <q-list>
              <q-item>
                <q-item-section>
                  ...
                  <q-input v-model="invoice.account" dense outlined label="Account"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label class="q-pb-xs">Amount</q-item-label>
                  <q-input v-model="invoice.amount" dense outlined label="Amount"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-input v-model="invoice.due_date" dense outlined mask="date" label="Due Date">
                    <template v-slot:append>
                      <q-icon name="event" class="cursor-pointer">
                        <q-popup-proxy
                          ref="dueDateProxy"
              ...
              <q-item>
                <q-item-section>
                  ...
                  <q-input v-model="invoice.invoice_type" dense outlined label="Invoice Type"/>
                </q-item-section>
              </q-item>
              <q-item>
                <q-item-section>
                  <q-item-label class="q-pb-xs">Status</q-item-label>
                  <q-input v-model="invoice.status" dense outlined label="Status"/>
                </q-item-section>
              </q-item>
            </q-list>
          </q-form>
